...
This your app's engine (kitchen). Your server function uses ```reactive({...})``` functions that listen for user input, do something, and send results to the user. Reactives are like nosy people who spy on everyone and re-fire if they detect a change.
