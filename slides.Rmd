...
<iframe src="`paste0(path, 'workflow_net.html')`" style="border:0;"></iframe>
...
In the example above, as soon as the user asks for a different subset of data in the UI, `r ct(corange, "Karen")` detects it and creates the new subset. `r ct(cgreen, "Garrett")` is always spying on Karen and re-models the data as soon as her state changes. `r ct(cpurple, "Steve")` is always spying on Garrett and re-runs the graph when his state changes.  
