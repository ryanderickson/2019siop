...
> - does data presentation as part of your job?
> - is familiar with R?  
...
1. Better data presentation (15-20 min)  
2. How  
    - flexdashboard (15 min)    
    - shiny  (10-15 min)  
3. Questions (5 min)  
...
> - `r ct(cgreen, "**Capitalize on schemas**")`     
> - `r ct(cgreen, "**Create layers of detail**")`  
...
The more you have to explain what a visual shows, the more useless it is. Take advantage of intuition:  

**Do**

- Use color **or** shape to show groups  
- Use size to show size  
- Use hot or cool color schemes appropriately  
- Use maps to show geospatial data   
- Use networks or dendrograms to show hierarchies  
- Follow web conventions for user interaction  

**Don't**

- Use more than 2 layers (e.g., shape + color)      
- Use maps if the data isn't geospatially-relevant  
- Explain the obvious (e.g., "Years" for an axis showing 1970 - 2019)  
- Add superfluous visual elements (e.g., borders, shadow)  
...
Help everyone - all levels - use the data to improve VA. We tried data cubes and giant PowerPoints, and they were great for the few people who had the patience to use them. We tried summaries, but they were too broad. 

In 2017, we developed the AES Dashboard: [link to demo db]
