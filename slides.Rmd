...
Shiny apps need to be connected to an instance of R because the server.R code needs a place to run. There are several options for hosting depending on your use case:

1. ```+ free, + easy, + secure, - accessible``` :: Locally on your machine   
2. ```+ free, + easy, - secure, + accessible``` :: Shinyapps.io  
3. ```- free, + easy, + secure, + accessible``` :: RStudio Connect  
4. ```+ free, - easy, + secure, + accessible``` :: Shinyproxy  
